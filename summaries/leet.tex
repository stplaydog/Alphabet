...
\subsection*{Hard}
\begin{enumerate}
\item Different ways to add parenthesis
\end{enumerate}
...
\item Find Peak Element \cite{162}
\item Longest Consecutive Sequence \cite{128}
\item Largest Rectangle in Histogram \cite{084}
...
\subsection*{Easy}
288 Unique Word Abbreviation \cite{288}
170 Two Sum III - Data structure design \cite{170}
155 Min Stack  \cite{155}
225 Implement Stack using Queues \cite{255}
232 Implement Queue using Stacks \cite{232}

\subsection*{Median}
281 Zigzag Iterator \cite{281}
244 Shortest Word Distance II \cite{244}
297 Serialize and Deserialize Binary Tree \cite{297}
284 Peeking Iterator \cite{284}
208 Implement Trie (Prefix Tree) \cite{288}
251 Flatten 2D Vector \cite{251}
173 Binary Search Tree Iterator \cite{173}
211 Add and Search Word - Data structure design \cite{211}

\subsection*{Hard}
146 LRU Cache \cite{146}
295 Find Median from Data Stream \cite{295}
